...
class RGBT234Dataset(BaseDataset):
    ...
    def __init__(self, split):
        super().__init__()
        self.base_path = self.env_settings.rgbt234_path # os.path.join(self.env_settings.gtot_path, split)
    ...
    def _get_sequence_list(self, split):
        sequence_list= ['supbus', 'walkingwoman', 'glass', 'scooter', 'cycle2', 'shake', 'single1', 'raningcar', 'threewoman2', 'blackwoman', 'yellowcar', 'tallman', 'kite2', 'manypeople1', 'elecbike3', 'man3', 'car41', 'child1', 'mandrivecar', 'glass2', 'floor-1', 'elecbike', 'manwithbag', 'playsoccer', 'womancross', 'inglassandmobile', 'guidepost', 'elecbikechange2', 'flower1', 'manonelecbike', 'supbus2', 'man7', 'run2', 'hotkettle', 'tricycle9', 'toy3', 'elecbike2', 'elecbikewithlight', 'walkingman20', 'dog', 'redcar2', 'woman4', 'blueCar', 'threepeople', 'mancrossandup', 'tricycle6', 'toy4', 'bikemove1', 'car4', 'womanleft', 'green', 'caraftertree', 'greyman', 'woman2', 'redmanchange', 'car20', 'womaninblackwithbike', 'redbag', 'threeman2', 'crossroad', 'whiteman1', 'tricycle1', 'whitesuv', 'man4', 'child', 'tricycletwo', 'cycle5', 'manlight', 'toy1', 'woman48', 'rainingwaliking', 'cycle1', 'soccer2', 'cycle4', 'walkingtogether', 'greywoman', 'woman96', 'twoman', 'elecbikewithlight1', 'man55', 'afterrain', 'womanpink', 'soccer', 'mancross', 'womanfaraway', 'aftertree', 'people3', 'biketwo', 'woman100', 'tree3', 'tree5', 'straw', 'maningreen2', 'child4', 'luggage', 'mancross1', 'walkingman41', 'man2', 'womanrun', 'man23', 'dog1', 'whitecarafterrain', 'stroller', 'nightcar', 'oldman', 'oldwoman', 'twowoman', 'man29', 'manypeople', 'twoman1', 'soccerinhand', 'man8', 'rmo', 'man5', 'baby', 'graycar2', 'walking40', 'bus6', 'man24', 'crouch', 'manonboundary', 'carLight', 'walkingwithbag2', 'woman6', 'man68', 'whitebag', 'carnotfar', 'people', 'manafterrain', 'tricycle', 'basketball2', 'man28', 'dog10', 'redcar', 'woamn46', 'diamond', 'womanred', 'children4', 'greentruck', 'child3', 'threeman', 'walkingtogether1', 'night2', 'man88', 'single3', 'walkingtogetherright', 'fog6', 'tricyclefaraway', 'dog11', 'twowoman1', 'whitecar4', 'manontricycle', 'manwithbag4', 'woman1', 'manoccpart', 'car3', 'children3', 'baketballwaliking', 'jump', 'woman3', 'nightthreepeople', 'run', 'woman', 'twoperson', 'elecbikeinfrontcar', 'children2', 'run1', 'whitecar3', 'nightrun', 'maninglass', 'bicyclecity', 'bikeman', 'woman89', 'manypeople2', 'shoeslight', 'car66', 'cycle3', 'whitecar', 'call', 'carnotmove', 'bluebike', 'kettle', 'walkingman12', 'maninblack', 'manwithumbrella', 'tricycle2', 'maninred', 'walkingmantiny', 'manfaraway', 'twoman2', 'manwithbasketball', 'manup', 'woman99', 'flower2', 'walkingman', 'elecbike10', 'man9', 'fog', 'twoelecbike1', 'manwithluggage', 'walkingwithbag1', 'manout2', 'notmove', 'man26', 'takeout', 'baginhand', 'bike', 'mobile', 'twoelecbike', 'hotglass', 'woamnwithbike', 'man45', 'elecbikewithhat', 'trees', 'car37', 'walkingman1', 'boundaryandfast', 'tree2', 'face1', 'womanwithbag6', 'push', 'man22', 'kite4', 'walking41', 'car10', 'man69', 'together', 'oldman2', 'people1', 'walkingnight', 'balancebike', 'car', 'carred', 'orangeman1']
