...
class UAV_RGBT(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=opencv_loader, split=None, modality = "RGBT"):
        ...
        root = '/data1/Datasets/Tracking/VTUAV'
        ...
        self.init_idx = np.load("/data1/Code/liulei/ACMMM2023Extension/TBSI/lib/train/dataset/init_frame.npy", allow_pickle=True).item()
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        if self.modality in ['RGB']:
            ...
            frame_list = [np.concatenate((frame_list_v[0], frame_list_i[0]), 2)]
