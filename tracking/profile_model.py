...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='ostrack_rgbt', choices=['tbsi_track'],
...
if __name__ == "__main__":
    ...
    # model_constructor = model_module.build_qat_cls_weight_guide_trans_encoder_track
    model_constructor = model_module.build_ostrack_rgbt
