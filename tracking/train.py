...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='qat_cls_weight_guide_trans_encoder_track', help='training script name')
    parser.add_argument('--config', type=str, default='vitb_256_qat_32x1_1e4_lasher_15ep_sot_everyepoch', help='yaml configure file name')
